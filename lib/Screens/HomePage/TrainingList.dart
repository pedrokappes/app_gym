        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(_dateTime.day.toString(),style:
                  ...
                  child: Column(
                    children: [
                      Stack(
                        ...
                        children: [
                             Ink.image(image:
                      AssetImage('assets/images/treinobraço.png'),
                      child: InkWell(
                      onTap: (){
                      ...
                      Padding(
                        ...
                        child: Stack(
                            ...
                            children: [
                              Ink.image(image:
                              AssetImage('assets/images/treinopeito.png'),
                                child: InkWell(
                                    onTap: (){
                                      Navigator.push(context,
                                          MaterialPageRoute(builder: (_) => Peitoral()));
                                    }
                                ),
                                height: 240,
                                fit: BoxFit.cover,
                      ...
                      Stack(
                          ...
                          children: [
                            Ink.image(image:
                            AssetImage('assets/images/aerobico.png'),
                              child: InkWell(
                                  onTap: (){
                                    Navigator.push(context,
                                        MaterialPageRoute(builder: (_) => Aerobico()));
                                  }
                              ),
                              height: 240,
                              fit: BoxFit.cover,
                  ...
                  Padding(padding: EdgeInsets.only(top: 8),
                    child:
                      Stack(
                          ...
                          children: [
                            Ink.image(image:
                            AssetImage('assets/images/abdomen.png'),
                              child: InkWell(
                                  onTap: (){
                                    Navigator.push(context,
                  ...
                  Padding(padding: EdgeInsets.only(top: 8),
                    child:
                      Stack(
                          ...
                          children: [
                            Ink.image(image:
                            AssetImage('assets/images/costas.jpg'),
                              child: InkWell(
                                  onTap: (){
                                    Navigator.push(context,
